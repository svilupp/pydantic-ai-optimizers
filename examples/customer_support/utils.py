...
def calculate_classification_score(predicted: SupportClassification, expected: SupportClassification) -> float:
    ...
    if predicted.component == expected.component:
        ...
        if predicted.component.lower() in expected.component.lower() or expected.component.lower() in predicted.component.lower():
            score += 0.075
