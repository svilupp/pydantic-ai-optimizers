...
def create_support_agent(prompt_file: str = "seed.md", model: str = "openai:gpt-5-nano") -> Agent[None, SupportClassification]:
    ...
    system_prompt = str(textprompts.load_prompt(prompts_dir / prompt_file))
